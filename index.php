...
<body>
    <!-- header -->
    <header class="container-fluid p-0 border-bottom">
        ...
        <div class="row">
            <ul class="d-flex eb_child align-items-center">
                <?php
                    $lists =['Introduzione','Norme sulla privacy','Termini di servizio','Tecnologie','Domande frequenti'];
                    foreach($lists as $list){
                        echo "<li class='list-unstyled px-3'>" . "<a class='text-decoration-none text-secondary fs-6 fw-bold'>" . $list . "</a>" . "</li>";
                    }
                ?>
            </ul>
        </div>
    ...
    <main class="container-fluid">
        ...
        <?php
            $paragraphs = [
                    ...
                    [
                        "faq" => "<h2>Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?</h2>",
                        ...
                        <p> Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a href='#' class='text-decoration-none'>Centro Google per la sicurezza online</a>.</p>
                        
                        <p><a href='#' class='text-decoration-none'>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>"
                    ],
                    [
                        "faq" => "<h2>Perché il mio account è associato a un paese?</h2>",
                        "answers" => "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:
                        <ol>
                    ...
                    [
                        "faq" => "<h2>Stabilire il paese associato al tuo account</h2>",
        ...
        ?>
        <div class="eb_main m-auto">
            <?php
                for( $i = 0; $i < count($paragraphs); $i++){
                    $list = $paragraphs[$i];

                    echo $list['faq'] . $list['answers'];
                }
